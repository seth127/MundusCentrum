...
```{r}
modify_unit(game, "big_grizz", moby_units[1:5],   "move", "F1")
modify_unit(game, "eric",      eric_units[1:6],   "move", "F4")
modify_unit(game, "chris",     chris_units[10:18],"move", "F4")
modify_unit(game, "chris",     chris_units[19],   "sneak","E7")
modify_unit(game, "chris",     chris_units[20],   "soar", "B1")
```
...
```{r}
modify_unit(game, "eric",      eric_units[1:6],   "retreat", "F7")
modify_unit(game, "chris",     chris_units[1:9],  "retreat", "F2")
```
...
```{r}
modify_unit(game, "big_grizz", moby_units[1:5], "defend", "F1")
modify_unit(game, "big_grizz", moby_units[6:7],   "move", "A3")
modify_unit(game, "big_grizz", moby_units[11:15], "move", "A7")
modify_unit(game, "big_grizz", moby_units[11:15], "move", "A5")
modify_unit(game, "eric",      eric_units[1:6], "defend", "F7")
modify_unit(game, "eric",      eric_units[7:8],   "move", "C5")
modify_unit(game, "eric",      eric_units[11:12], "move", "D2")
modify_unit(game, "chris",     chris_units[10:17],"move", "F2")
modify_unit(game, "chris",     chris_units[18],   "move", "E5")
modify_unit(game, "chris",     chris_units[20],   "soar", "B6")
```
...
```{r}
modify_unit(game, "big_grizz", moby_units[6:7],   "move", "B1")
modify_unit(game, "big_grizz", moby_units[11:15], "move", "B5")
modify_unit(game, "eric",      eric_units[7:8],   "move", "F3")
modify_unit(game, "eric",      eric_units[11:12], "move", "E3")
modify_unit(game, "chris",     chris_units[1:17],"attack","F1")
modify_unit(game, "chris",     chris_units[18], "attack", "F7")
modify_unit(game, "chris",     chris_units[19],   "sneak","F8")
modify_unit(game, "chris",     chris_units[20],   "soar", "C3")
```
...
```{r}
modify_unit(game, "big_grizz", moby_units[1:6], "retreat", "E2")
modify_unit(game, "eric",      eric_units[1:6], "retreat", "F8")
modify_unit(game, "chris",     chris_units[20], "retreat", "C5")
```
