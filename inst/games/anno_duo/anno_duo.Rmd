...
```{r}
game <- game %>%
  modify_unit("big_grizz", 1,   "move",  "C2") %>%
  modify_unit("big_grizz", c(2, 7, 17, 18),   "control",  "D4") %>%
  modify_unit("big_grizz", c(3, 5:6, 13, 22),   "soar",  "H2") %>% # transport
  modify_unit("big_grizz", c(8, 23),   "move",  "C5") %>% # transport
  modify_unit("big_grizz", 9,   "move",  "F5") %>%
  modify_unit("big_grizz", c(10:12, 16),   "move",  "D1") %>%
  ...
  modify_unit("eric",      15:18,   "soar","I4") %>% # transport 
  modify_unit("eric",      19,   "move","G6") %>%
  modify_unit("eric",      20,   "move","E6") %>%
  modify_unit("eric",      21,   "move","E4") %>%
  modify_unit("eric",      c(22:24, 26),   "soar", "H3") %>% # transport 
  modify_unit("eric",      25,   "move","G8") %>%
  modify_unit("eric",      27,   "move","F4") %>%
  ...
  modify_unit("chris",     2,  "move","A8") %>%
  modify_unit("chris",     19,  "move","B10") %>%
  modify_unit("chris",     21,  "move","B11") %>%
  modify_unit("chris",     c(4, 15),  "move","B7") %>%
  modify_unit("chris",     20,  "move","E1") %>%
...
```{r}
game <- game %>%
  modify_unit("big_grizz", 1,   "move",  "B4") %>%
  ...
  modify_unit("big_grizz", c(10:12, 16),   "move",  "B4") %>%
  ...
  modify_unit("eric",      21,   "move","A8") %>%
  modify_unit("eric",      c(22:24, 26),   "move","H2") %>%
  modify_unit("eric",      25,   "control","G8") %>%
  modify_unit("eric",      27,   "move","F5") %>%
  modify_unit("eric",      28,   "move","H3") %>%
