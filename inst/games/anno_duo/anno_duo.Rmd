...
game <- game %>%
  ...
  #modify_unit("eric", "F8",   "move",  "F5") %>%

  modify_unit("chris", c(20), "defend", "E2") %>%
  modify_unit("chris", c(5, 23), "defend", "B2") %>%
  modify_unit("chris", c(16, 25), "defend", "A5") %>%
  modify_unit("chris", c(3, 17, 18), "defend", "B9") %>%
  
  modify_unit("chris", c(1,3,17,18) , "move", "B11") %>%
  modify_unit("chris", 2, "move", "E2") %>%
  modify_unit("chris", c(4,7) , "move", "B2") %>%
  modify_unit("chris", 6, "move", "A1") %>%
  modify_unit("chris", 8, "move", "B5") %>%
  modify_unit("chris", 9, "move", "B9") %>%
  modify_unit("chris", c(10,24) , "move", "E1") %>%
...
* Currently sneaky units _can_ be seen, unless their move is actually `"sneak"`. Are we cool with that? It's easier to implement and honestly I kinda like it anyway. -- Seth
